...
10. **Persistent cache**: Translation bundles cached in localStorage with TTL
    and LRU eviction
...
- **Persistent cache**: Bundles cached in localStorage/sessionStorage with TTL
  and LRU

Lightweight, type-safe, cross-platform, suitable for browser and server i18n
needs.
